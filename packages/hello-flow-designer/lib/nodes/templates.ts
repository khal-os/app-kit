import type { FlowFunctionJson, MessageJson } from '../schema/flow.schema';
	...
	},
	{
		...
		data: {
			...
			task_messages: [
				{
					role: 'system',
					content: 'You are a helpful assistant. Ask the user questions and use available functions to proceed.',
				} as MessageJson,
			],
			functions: [] as FlowFunctionJson[],
		},
