...
import { type FlowJson, getCompiledJsonSchema } from '../schema/flow.schema';
...
const validateFlow = ajv.getSchema<FlowJson>(flowSchema.$id as string) ?? ajv.compile<FlowJson>(flowSchema);
