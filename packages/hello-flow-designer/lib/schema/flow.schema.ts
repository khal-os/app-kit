...
export const ContextStrategyConfig = Type.Object({
	strategy: Type.Union([Type.Literal('APPEND'), Type.Literal('RESET'), Type.Literal('RESET_WITH_SUMMARY')]),
...
export const EdgeCondition = Type.Object({
	...
	language: Type.Optional(Type.Union([Type.Literal('python'), Type.Literal('jinja'), Type.Literal('dsl')])),
});
