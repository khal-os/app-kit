...
import type { FlowFunctionJson, FlowJson } from '../schema/flow.schema';
import { deriveNodeType } from '../utils/nodeType';

export function reactFlowToFlowJson(nodes: Node[], _edges: Edge[]): FlowJson {
